    ...
    if cs_structures is None:
        cs_structures = (
            [
                ...
                , CreateStructure(int("111", 2), [0], 0, 3, 3, "imul", None, None, None, None, None)
                ...
                , CreateStructure(int("111", 2), [0], 0, None, None, "lock", "inc", "qword", "ptr", None, None)
                ...
                , CreateStructure(int("111", 2), [0], 0, None, None, "vucomisd", None, "qword", "ptr", None, None)
                ...
                , CreateStructure(int("111", 2), [1, 4], 1, None, None, "cmp", "qword", "ptr", None, None, None)  # not 100% safe
                , CreateStructure(int("111", 2), [1, 4], 1, None, None, "cmp", "dword", "ptr", None, None, None)  # not 100% safe
                , CreateStructure(int("111", 2), [1], 1, None, None, "cmp", "word", "ptr", None, None, None)
